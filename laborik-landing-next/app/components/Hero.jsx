      ...
      <div className="max-w-[1250px] mx-auto flex flex-col md:flex-row items-center justify-between px-8 lg:px-24 gap-20">
        ...
        <div className="md:w-[55%] space-y-7 text-center md:text-left">
          <h1 className="text-4xl sm:text-5xl lg:text-[3.3rem] font-extrabold leading-[1.15] tracking-tight font-sans">
            Diseñamos lo que viste a tu equipo, <br className="hidden md:block"/>
            y refleja la identidad de tu empresa.
          </h1>
          ...
          <a
            href="#catalog"
            className="inline-block bg-orange-500 text-white px-8 py-3 rounded-md text-base sm:text-lg font-semibold hover:bg-orange-600 transition-all duration-300 shadow-md"
          >
        ...
        <div className="hidden md:flex md:w-[45%] justify-center">
          <div className="relative w-[440px] h-[440px]">
            <Image
              ...
              fill
              className="object-cover rounded-xl shadow-2xl border border-orange-500/40"
            />
          </div>
        </div>
      </div>
