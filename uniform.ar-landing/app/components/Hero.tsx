...
export default function Hero() {
  return (
    <section
      id="hero"
      className="bg-[#F8F5F0] text-[#6B4A52] dark:bg-[#1a1221] dark:text-[#DCC7FF] w-full py-24 md:py-28 mt-16 transition-all duration-500"
    >
      ...
      <div className="max-w-[1250px] mx-auto flex flex-col md:flex-row items-center justify-between px-8 lg:px-24 gap-20">
        <div className="md:w-[55%] space-y-7 text-center md:text-left">
          ...
          <p className="text-[#6B4A52]/80 dark:text-violet-300 text-base sm:text-lg lg:text-[1.15rem] font-normal leading-relaxed max-w-md mx-auto md:mx-0">
          ...
          <a
            href="#catalog"
            className="inline-block bg-[#6B4A52] text-[#F8F5F0] dark:bg-violet-500 dark:text-white px-8 py-3 rounded-md text-base sm:text-lg font-semibold shadow-md hover:bg-[#5D3F47] dark:hover:bg-violet-600 hover:shadow-lg transition-all duration-300"
          >
        ...
        <div className="hidden md:flex md:w-[45%] justify-center">
          <div className="relative w-[440px] h-[440px]">
            ...
            <Image
              ...
              fill
              className="object-cover rounded-xl shadow-2xl border border-violet-400/30 hidden dark:block"
            />
          </div>
        </div>
      </div>
